                            ...
                            <c:otherwise>
                                ...
                                <c:forEach var="c" items="${cart}">
                                    <tr>
                                        ...
                                        <td class="cart_price"><p>${c.product.price}</p>
                                        </td>
                                        <td class="cart_price"><p>${c.quantity}</p>
                                        </td>
                                        <td class="cart_total"><p id="total" class="cart_total_price">${c.product.price*c.quantity}</p>
                                        </td>
