...
@WebServlet(
        urlPatterns = {"/jdbc"},
        initParams = {
                @WebInitParam(name="driver",value = "com.microsoft.sqlserver.jbc.SQLserverDriver"),
                @WebInitParam(name="url",value = "jdbc:sqlserver://localhost;databaseName=MDSK;"),
                @WebInitParam(name="username",value = "sa"),
                @WebInitParam(name="password",value = "YanLaoBan" )
        },loadOnStartup = 1
...
public class JDBCDemoServlet extends HttpServlet {
    ...
    public void init() throws ServletException{
        ...
        //String url="jdbc:sqlserver://localhost:databaseName=MDSK;";
        //String username="sa";
        //String password="YanLaoBan";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     // connection within do get--many times - bad may
